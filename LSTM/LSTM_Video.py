...
def objective(trial, task_name, video_data, labels, plot_dir, model_dir):
    ...
    for test_index in range(n_subjects):
        ...
        for val_index in train_val_ids:
            ...
            model.fit(X_train_video, y_train_scaled, epochs=20, batch_size=16, verbose=0,
...
study.optimize(lambda trial: objective(trial, task_name, video_data, labels, plot_dir, model_dir), n_trials=30)
