...
# Save directories
model_dir = f'/rds/user/sss77/hpc-work/New/MLModels/video/svr/'
plot_dir = f'/rds/user/sss77/hpc-work/New/MLModels/video/svr/plots_{task_name}/'
...
def objective(trial):
    ...
    plt.title(f"Video SVR - {task_name}")
    plt.xlabel('Fold')
    plt.ylabel('MAE')
    plt.legend()
    plt.grid(True)
