...
# Use audio features for training
X_combined = audio_data

# Save directories
model_dir = f'/rds/user/sss77/hpc-work/New/MLModels/audio/svr-rbf/'
plot_dir = f'/rds/user/sss77/hpc-work/New/MLModels/audio/svr-rbf/plots_{task_name}/'
...
def objective(trial):
    ...
    plt.title(f"Audio svr-rbf - {task_name}")
    plt.xlabel('Fold')
    plt.ylabel('MAE')
    plt.legend()
    plt.grid(True)
