...
# Save directories
model_dir = f'/rds/user/sss77/hpc-work/New/MLModels/video/dt/'
plot_dir = f'/rds/user/sss77/hpc-work/New/MLModels/video/dt/plots_{task_name}/'
...
def objective(trial):
    ...
    plt.title(f"Video DT - {task_name}")
    plt.xlabel('Fold')
    plt.ylabel('MAE')
    plt.legend()
    plt.grid(True)
