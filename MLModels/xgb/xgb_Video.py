...
model_dir = f'/rds/user/sss77/hpc-work/New/MLModels/video/xgb/'
plot_dir = f'/rds/user/sss77/hpc-work/New/MLModels/video/xgb/plots_{task_name}/'
...
def objective(trial):
    ...
    plt.title(f"Video xgb - {task_name}")
    plt.xlabel('Fold')
    plt.ylabel('MAE')
    plt.legend()
    plt.grid(True)
