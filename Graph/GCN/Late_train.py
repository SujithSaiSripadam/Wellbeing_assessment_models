...
from GCN_model import GCN, create_graph_list_V, create_graph_list_A, train_epoch_late, valid_epoch_late, train_epoch, valid_epoch
...
BASE_DIR = f"/rds/user/sss77/hpc-work/New/Graph/GCN_LF/{task_name}"
task_dir_V = os.path.join("/rds/user/sss77/hpc-work/New/Graph/Graph_Data/Modify_Data", taskv_name)
...
if __name__ == "__main__":
    ...
    output_dir = f"/rds/user/sss77/hpc-work/New/Graph/GCN_LF/{task_name}"
